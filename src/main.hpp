...
#define SDL_glBlendEquationSeparate glBlendEquationSeparate
#define SDL_glBindRenderbuffer glBindRenderbuffer
#define SDL_glRenderbufferStorage glRenderbufferStorage
#define SDL_glGenRenderbuffers glGenRenderbuffers
#define SDL_glFramebufferTexture2D glFramebufferTexture2D
#define SDL_glFramebufferRenderbuffer glFramebufferRenderbuffer
#define SDL_glBindFramebuffer glBindFramebuffer
#define SDL_glGenFramebuffers glGenFramebuffers
#define SDL_glBlitFramebuffer glBlitFramebuffer
#define SDL_glDeleteFrameBuffers glDeleteFramebuffers
#define SDL_glCheckFramebufferStatus glCheckFramebufferStatus
#endif
