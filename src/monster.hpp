...
enum AllyNPCChatter : int
{
	...
	ALLY_EVENT_INTERACT_ITEM_BLESSED
};
...
static const int MONSTER_SPECIAL_COOLDOWN_EARTH_ELEMENTAL_CAST = 500;
static const int MONSTER_SPECIAL_COOLDOWN_EARTH_ELEMENTAL_CAST2 = 600;
static const int MONSTER_SPECIAL_COOLDOWN_MOTH_CAST = 250;
static const int MONSTER_SPECIAL_COOLDOWN_BUGBEAR = 500;
static const int MONSTER_SPECIAL_COOLDOWN_MONSTER_D = 175;
...
//--Earth
static const int EARTH_ELEMENTAL_CAST_BLAST = 1;
static const int EARTH_ELEMENTAL_CAST_CHARGE = 2;
