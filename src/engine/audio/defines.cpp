...
std::vector<FMOD::Sound*> fortressmusic(3, nullptr);
std::vector<FMOD::Sound*> keepmusic(3, nullptr);
std::vector<FMOD::Sound*> backroomsmusic(2, nullptr);
std::vector<FMOD::Sound*> rooftopmusic(3, nullptr);
std::vector<FMOD::Sound*> arenamusic(2, nullptr);
...
FMOD::Sound* bastillemusic = nullptr;
FMOD::Sound* warrenmusic = nullptr;
FMOD::Sound* fraternitymusic = nullptr;
FMOD::Sound* penitentiarymusic = nullptr;
FMOD::Sound* automatmusic = nullptr;
FMOD::Sound* gatehousemusic = nullptr;
FMOD::Sound* credits_expansion_music = nullptr;
FMOD::Sound* throneroommusic = nullptr;
FMOD::Sound* voidvaultmusic = nullptr;
