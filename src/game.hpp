...
enum SoundChannelGroupIndex
{
	...
	SOUND_CHANNEL_GROUP_TRAP_MAGIC
};
...
Entity* spawnFociGib(real_t x, real_t y, real_t z, real_t dir, real_t velocityBonus, Uint32 parentUid, int sprite, Uint32 seed, Entity* autoHitTarget = nullptr);
...
Entity* spawnExplosion(Sint16 x, Sint16 y, Sint16 z, SoundChannelGroupIndex channelIndex = SOUND_CHANNEL_GROUP_NO_CHANNEL_PICK, int volumeOverride = 0);
