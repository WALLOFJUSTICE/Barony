...
std::vector<std::pair<const char*, const char*>> spriteEditorNameStrings =
{
	{ "NULL",							""},
	{ "PLAYER START",					"map" },
	{ "DOOR (East-West)",               "doors" },
	{ "DOOR (North-South)",             "doors" },
	{ "TORCH (West Wall)",              "objects" },
	{ "TORCH (North Wall)",             "objects" },
	{ "TORCH (East Wall)",              "objects" },
	{ "TORCH (South Wall)",             "objects" },
	{ "ITEM",							"interactables" },
	{ "GOLD",			                "interactables" },
	{ "RANDOM (Dependent on Level)",    "npcs" },
	{ "LADDER",							"map" },
	{ "FIREPLACE",						"interactables" },
	{ "Flame Sprite (Not Used)",        ""},
	{ "FOUNTAIN",						"interactables" },
	{ "SINK",							"interactables" },
	{ "Flame Sprite (Not Used)",        ""},
	{ "Lever",							"mech" },
	{ "Wire",							"mech" },
	{ "GATE (North-South)",             "doors" },
	{ "GATE (East-West)",               "doors" },
	{ "CHEST",							"interactables" },
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	...
	{ "ARROW TRAP",						"mech" },
	{ "PRESSURE PLATE",                 "mech" },
	{ "PRESSURE PLATE (Latch On)",      "mech" },
	{ "SHOPKEEPER",						"npcs" },
	{ "GOBLIN",							"npcs" },
	{ "MINOTAUR SPAWN TRAP",			"mech" },
	{ "BOULDER TRAP",                   "mech" },
	{ "HEADSTONE",						"interactables" },
	{ "NULL",							""},
	{ "LAVA",							""},
	{ "NOT USED",						""},
	{ "LADDER HOLE",                    "objects" },
	...
	{ "WALL BUSTER",                    "mech" },
	{ "WALL BUILDER",                   "mech" },
	{ "MAGIC BOW",						"interactables" },
	{ "MAGIC SPEAR",                    "interactables" },
	{ "GNOME",							"npcs" },
	{ "DEVIL",							"npcs" },
	{ "DEVIL TELEPORT LOCATION",        "misc" },
	{ "DEVIL TELEPORT LOCATION",        "misc" },
	{ "DEVIL TELEPORT LOCATION",        "misc" },
	{ "DEMON",							"npcs" },
	{ "IMP",							"npcs" },
	...
	{ "NOT USED",						""},
	{ "SUMMON TRAP",                    "mech" },
	{ "CRYSTAL SHARD (West Wall)",      "objects" },
	{ "CRYSTAL SHARD (North Wall)",     "objects" },
	{ "CRYSTAL SHARD (East Wall)",      "objects" },
	{ "CRYSTAL SHARD (South Wall)",     "objects" },
	{ "BOULDER TRAP SINGLE (Roll East)","mech" },
	{ "BOULDER TRAP SINGLE (Roll South)","mech" },
	{ "BOULDER TRAP SINGLE (Roll West)", "mech" },
	{ "BOULDER TRAP SINGLE (Roll North)","mech" },
	{ "POWER CRYSTAL",                  "interactables" },
	{ "ARMED BEAR TRAP",                "mech" },
	{ "STALAG-COLUMN",                  "objects" },
	{ "STALAGMITE SINGLE",              "objects" },
	{ "STALAGMITE MULTIPLE",            "objects" },
	{ "STALAGTITE SINGLE",              "objects" },
	{ "STALAGTITE MULTIPLE",            "objects" },
	{ "GATE INVERTED (North-South)",    "doors" },
	{ "GATE INVERTED (East-West)",      "doors" },
	{ "LEVER WITH TIMER",               "mech" },
	{ "PEDESTAL",						"interactables" },
	{ "MID PORTAL",						"map" },
	{ "TELEPORTER",						"map" },
	{ "CEILING TILE MODEL",             "objects" },
	{ "SPELL TRAP CEILING",             "mech" },
	{ "ARCANE CHAIR",                   "objects" },
	{ "ARCANE BED",						"objects" },
	{ "BUNK BED",						"objects" },
	{ "COLUMN DECO",                    "objects" },
	{ "PODIUM",							"objects" },
	...
	{ "NOT USED",						""},
	{ "CUSTOM EXIT",                    "map" },
	{ "READABLE BOOK",                  "interactables" },
	{ "SENTRYBOT",						"npcs" },
	{ "SPELLBOT",						"npcs" },
	{ "DUMMYBOT",						"npcs" },
	{ "GYROBOT",						"npcs" },
	{ "UNUSED",							"" },
	{ "STATUE ANIMATOR",                "objects" },
	{ "STATUE",							"objects" },
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	...
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "TELEPORT SHRINE",                "interactables" },
	{ "SPELL SHRINE",                   "interactables" },
	{ "COLLIDER DECORATION",            "objects" },
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	...
	{ "GREMLIN",						"npcs" },
	{ "WALL LOCK (East)",               "mech" },
	{ "WALL LOCK (South)",              "mech" },
	{ "WALL LOCK (West)",               "mech" },
	{ "WALL LOCK (North)",              "mech" },
	{ "WALL BUTTON (East)",             "mech" },
	{ "WALL BUTTON (South)",            "mech" },
	{ "WALL BUTTON (West)",             "mech" },
	{ "WALL BUTTON (North)",            "mech" },
	{ "NO DIG TILE",                    "map" },
	{ "IRON DOOR (North-South)",        "doors" },
	{ "IRON DOOR (East-West)",          "doors" },
	{ "SLIPPERY TILE",                  "map" },
	{ "WIND TILE",						"map" },
	{ "SLOW TILE",						"map" },
	{ "NOT USED",						""},
	...
	{ "NOT USED",						""},
	{ "NOT USED",						""},
	{ "CAULDRON",						"interactables" },
	{ "WORKBENCH",						"interactables" },
	{ "MAILBOX",						"interactables" },
	{ "MAILBOX",						"interactables" },
	{ "GRYPHON",						"npcs" },
	{ "FORCEFIELD",						"objects" },
	{ "WIDE GATE (North-South)",        "doors" },
	{ "WIDE GATE (East-West)",			"doors" },
	{ "HAUNTED_ARMOR",                  "npcs" },
	{ "MINIMIMIC",						"npcs" },
	{ "NOT USED",						""},
	{ "NOT USED",						""},
...
void setSpriteAttributes(Entity* entityNew, Entity* entityToCopy, Entity* entityStatToCopy)
{
		...
		|| spriteType == 39 )
	{
		...
		{
			// copy old entity attributes to newly created.
			entityNew->eternalShrineDir = entityToCopy->eternalShrineDir;
		}
		else
		{
			// set default new entity attributes.
