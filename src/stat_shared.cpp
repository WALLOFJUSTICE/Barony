...
void setDefaultMonsterStats(Stat* stats, int sprite)
{
	switch ( sprite )
	{
		...
		case (1000 + DUCK_SMALL):
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + WATER_ELEMENTAL):
			stats->type = WATER_ELEMENTAL;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 200;
		...
		case (1000 + DRAGON):
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + MONSTER_UNUSED_11):
			stats->type = MONSTER_UNUSED_11;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 10;
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + MONSTER_UNUSED_12):
			stats->type = MONSTER_UNUSED_12;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 10;
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + MONSTER_UNUSED_13):
			stats->type = MONSTER_UNUSED_13;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 10;
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + MONSTER_UNUSED_14):
			stats->type = MONSTER_UNUSED_14;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 10;
			...
			stats->RANDOM_GOLD = 0;
			break;
		case (1000 + MONSTER_UNUSED_15):
			stats->type = MONSTER_UNUSED_15;
			stats->stat_appearance = local_rng.rand();
			stats->inventory.first = NULL;
			stats->inventory.last = NULL;
			stats->MAXHP = 10;
